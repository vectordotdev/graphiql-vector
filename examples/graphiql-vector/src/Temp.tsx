...
import type {
  CodeMirrorType,
  CodeMirrorEditor,
} from '@graphiql/react/types/editor/types';
...
export function VectorExecuteButton() {
  //  const { queryEditor, setOperationName, responseEditor } = useEditorContext({
  //    nonNull: true,
  //    caller: ExecuteButton,
  //  });
  const editorContext = useEditorContext({
    nonNull: true,
    caller: VectorExecuteButton,
  });
  ...
  return (
    <Tooltip label={'run-vrl'}>
      <button
        {...buttonProps}
        onClick={() => {
          console.log('initializing wasm');

          console.log('Attempting to run vrl with args: ');
          console.log(vrlInput);
          init().then(() => {
...
// function VectorEditor(container: HTMLElement) {
...
export function GraphiQLInterface(props: GraphiQLInterfaceProps) {
  ...
  //     if (temp) {
  //         editorContext.setQueryEditor(temp);
  //     }
                ...
                >
                  <div ref={editorToolsResize.firstRef}>
                    ...
                    >
                      ...
                      >
                        <VectorExecuteButton></VectorExecuteButton>
                        {toolbar}
                      </div>
                    </section>
                  </div>
